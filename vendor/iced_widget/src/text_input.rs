        ...
        match &event {
            ...
            Event::Keyboard(keyboard::Event::KeyPressed {
                ...
                if let Some(focus) = &mut state.is_focused {
                    ...
                    match clipboard_shortcut(
                        key,
                        *physical_key,
                        state.keyboard_modifiers,
                    ) {
                        Some(ClipboardShortcut::Copy) if !self.is_secure => {
                        ...
                        Some(ClipboardShortcut::Cut) if !self.is_secure => {
...
fn clipboard_shortcut(
    ...
    match key.to_latin(physical_key) {
        Some('c') if modifiers.command() => Some(ClipboardShortcut::Copy),
        Some('x') if modifiers.command() => Some(ClipboardShortcut::Cut),
