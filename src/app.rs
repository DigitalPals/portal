...
pub struct UiState {
    ...
    pub portal_hub_diagnostics: Option<crate::hub::diagnostics::PortalHubDiagnosticsReport>,
...
pub struct VaultUiState {
    ...
    pub enrollment_audit_events: Vec<crate::hub::vault_enrollment::VaultAuditEvent>,
...
impl Default for VaultUiState {
    fn default() -> Self {
        Self {
            ...
            enrollment_audit_events: Vec::new(),
    ...
    pub fn new() -> (Self, Task<Message>) {
        ...
        let mut app = Self {
            ui: UiState {
                ...
                portal_hub_diagnostics_loading: false,
                portal_hub_diagnostics: None,
        ...
        let main_content: Element<'_, Message> = match &self.ui.active_view {
            View::Settings => settings_page_view(
                SettingsPageContext {
                    ...
                    portal_hub_diagnostics_loading: self.ui.portal_hub_diagnostics_loading,
                    portal_hub_diagnostics: self.ui.portal_hub_diagnostics.clone(),
