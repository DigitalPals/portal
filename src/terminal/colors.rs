...
/// Convert an alacritty ANSI color to an iced Color (uses default palette)
...
/// Convert a named color to iced Color (uses default palette)
...
/// Convert a 256-color indexed color to iced Color (uses default palette for 0-15)
